      ...
      p.language === "pt" && p.type === "similarity"
        ...
        : p.language === "pt" && p.type === "relatedness"
          ...
          : p.language === "en" && p.type === "similarity"
            ? "Please rate from 0 to 4 the semantic similarity of the following pair of words, with 0 being words not similar at all and 4 very similar words"
            : "Please rate from 0 to 4 the semantic relatedness of the following pair of words,with 0 being words not related at all and 4 very related words";
